...
#timit=/Users/lizhiyi/Documents/projects_inhands/test/test_kaldi/dataset/TIMIT # @localhost lizhiyi macbook

#local/timit_data_prep.sh $timit || exit 1
#local/timit_prepare_dict.sh # remarks: remove the old file before rerun it
